...
const Article = ({img, title, date, link}) => {
    return(
        ...
        justify-between bg-light dark:bg-dark dark:text-light text-dark first:mt-0 border border-solid border-dark dark:border-light
